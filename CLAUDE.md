...
- **Use real timestamps, never invent them.** Run `date -u +%Y-%m-%dT%H%MZ` for any changelog or diary entry. Don't pick a future timestamp to maintain ordering. Don't use colons in filenames — keep the basic-form ISO 8601 (`T1843Z`, not `T18:43Z`).
